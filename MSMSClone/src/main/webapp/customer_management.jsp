...
}else
{
	...
	<div class="container">
		<div class="indexbox">
			<p><p>
			<h2>Customer Management</h2>
			<form action="update_customer.jsp"><button class="button1">Update Account Details</button></form>
			<form action="view_all_customer.jsp"><button class="button1">Account Details</button></form>
			<form action="home.jsp"><button class="button1">Exit</button></form>
		</div>
	</div>
</body>
